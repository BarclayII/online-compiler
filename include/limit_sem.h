...
int limit_sem_wait(limit_sem_t *, void *(*)(void *), void *, void *);
int limit_sem_trywait(limit_sem_t *, void *(*)(void *), void *, void *);
int limit_sem_timedwait(limit_sem_t *, const struct timespec *, void *(*)(void *),
    void *, void *);
int limit_sem_post(limit_sem_t *, void *(*)(void *), void *, void *);
int limit_sem_trypost(limit_sem_t *, void *(*)(void *), void *, void *);
